...
nightToggler.onclick = () =>{
    ...
    if(nightToggler.classList.contains("bi-toggle-on")){
        ...
        textCarousel.style.backgroundColor = "var(--dark-color)";
        textCarousel.style.color = "var(--light-color)";
    ...
    //light theme
        ...
        textCarousel.style.backgroundColor = "var(--light-text-carousel-color)";
        textCarousel.style.color = "var(--light-color)";
